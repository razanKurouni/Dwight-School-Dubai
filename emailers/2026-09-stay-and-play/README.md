...
| REGISTER 2 (Open Morning) | https://dwight.ae/event-calendar/open-morning-october2026/ |
...
1. Upload the `images/` folder to the mailing platform / web host and replace every `images/` path in `index.html` with the absolute hosted URL (e.g. `https://dwight.ae/emailers/sept26/`). Email clients cannot load relative paths.
2. Send a test to Outlook, Gmail and iPhone Mail.
